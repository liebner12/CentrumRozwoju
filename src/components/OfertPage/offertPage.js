...
import OffertDetails from "./offert-details"
import OffertImages from "./offert-images"
...
`
class OffertPage extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      item: 1,
        ...
        <div id="item-section" className="my-section">
          <StyledSection className="container">
            <div className="container">
              <OffertDetails params={this.state.item} />
              <CardGrid>
                <OverlayTrigger
                  key="top"
                  placement="top"
            ...
            <div className="container">
              <OffertImages params={this.state.item} />
            </div>
          </StyledSection>
        </div>
      </div>
